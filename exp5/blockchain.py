...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None, curr_hash=None):
        """
        创建一个新的区块到区块链中
        ...
        block = {
            ...
            'hash': curr_hash or hashlib.sha256(f'{previous_hash}{proof}'.encode()).hexdigest(),
        }
...
def mine():
    ...
    proof, curr_hash = blockchain.proof_of_work(previous_hash)
